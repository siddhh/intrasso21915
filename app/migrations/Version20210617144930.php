 ...
 */
final class Version20210617144930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT NOT NULL, proprietaire_id INT NOT NULL, emprunteur_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description BYTEA NOT NULL, est_emprunte BOOLEAN NOT NULL, date_suppression TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE nature (id INT NOT NULL, categories_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE "user" ALTER actif SET DEFAULT \'false\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE liste_objets_nature DROP CONSTRAINT FK_40923F67314EE359');
        $this->addSql('ALTER TABLE article_nature DROP CONSTRAINT FK_DB1F15273BCB2E4B');
        $this->addSql('ALTER TABLE liste_objets_nature DROP CONSTRAINT FK_40923F673BCB2E4B');
        ...
        $this->addSql('ALTER TABLE "user" ALTER actif DROP DEFAULT');
    }
}
